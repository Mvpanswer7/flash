...
object ProxyApp extends App {
  ...
  def testHive = {
    ...
    val rql1 =
      """
        |connect ck where `url`="jdbc:clickhouse://192.168.200.151:8123" and user="default" and password="1Qaaz2Wsx" as db1;
  ...
  def testClickHouse = {
    val rql0 =
      """
        |connect ck where `url`="jdbc:clickhouse://192.168.200.151:8123/default" and user="default" and password="1Qaaz2Wsx" as db1;
  ...
  def testHbase = {
    val rql0 =
      """
        ...
        |and `family`="info" as xql_example;
        |
...
//  testHbase
  ...
  def testJDBC = {
     val rql0 =
      """
        |connect jdbc where `url`="jdbc:mysql://192.168.8.16:4000/insight_sources?characterEncoding=utf8" and user="insight-super" and password="123" as db1;
